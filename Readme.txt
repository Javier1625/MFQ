# MFQ
Esta aplicación implementa una simulación de Múltiples colas realientadas en Python 3.9.
...
===========================================================
Cola1
 * Nivel1: La prioridad nmás alta es 0
 ...
 * Interrumpible: Si un proceso P1 está siendo itinerado y llega P2 con mayor prioridad,
   P1 baja a la cola FIFO (Nivel 2) y se itinera P2
...
Supongamos que la Cola1 está vacía y se está procesando u proceso en Cola2. En este caso
...
4         6         34          22    
5         14        35          29    
Tiempo de Respuesta Promedio=37.0 
Tiempo de Termino Promedio=25.0 
Tiempo de Espera Promedio=8.8 
Turn Around Time Promedio=21.8 
